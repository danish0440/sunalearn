            ...
            <DropdownMenuTrigger asChild>
                ...
                >
                    <div className="flex items-center gap-2">
                        <div className="w-4 h-4 rounded bg-gradient-to-br from-blue-500 to-purple-600 text-white text-xs flex items-center justify-center font-bold">M</div>
<span>Maia</span>
            ...
            >
                ...
                >
                    ...
                    <div className="flex flex-col">
                        <span className="font-semibold text-sm">Maia</span>
