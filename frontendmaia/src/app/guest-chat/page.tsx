...
import { MaiaLogo } from '@/components/sidebar/kortix-logo';
...
const sampleResponses = [
  "I'm MAIA, your AI assistant! I'd love to help you with that. However, as a guest user, you're experiencing a limited demo version. To get full AI responses and save your conversations, please sign up for a free account!",
        ...
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">MAIA Guest Chat</span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Button
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {messages.length === 0 && (
            <div className="text-center py-12">
              <div className="mb-4">
                <MaiaLogo className="h-16 w-16 mx-auto text-muted-foreground" />
              </div>
              <h2 className="text-xl font-semibold mb-2">Welcome to MAIA Guest Chat</h2>
              ...
              <Card className="bg-muted">
                <CardContent className="p-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-muted-foreground">MAIA is thinking...</span>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
      ...
      <div className="border-t border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 p-4">
        <div className="max-w-4xl mx-auto">
          <ChatInput
            ...
            loading={isLoading}
            placeholder="Ask MAIA anything... (Guest mode - limited responses)"
            value={inputValue}
